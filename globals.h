...
extern
#endif
double lam_L,***W_tsn,***vir_func,***vir_funcpp,***vir_funcpg,**q_noise,Diff_rot,*verlet_a,*verlet_b,p_m,**x_bac,**gn_bac,**grf_bf_x, ***epslon,**real_trq,**trq,**euler_ang,***euler_Q,**euler_adot,quantern4,**euler_q,***euler_B,***euler_A,***dAdphi,***dAdtheta,***dAdpsi,**x, **f , *tmp, **grid_W, V, L[Dim], dx[Dim], gvol, Lh[Dim], 
...
extern
#endif
int  Nsp ,optm_L, L_dim,L_fren,L_aver,rst_para,uni_sig,nstot, *tp, nA, nB, nD, Nha, Nhb, Nhc,Nda, Ndb,
